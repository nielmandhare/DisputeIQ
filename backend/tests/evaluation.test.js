// Tests for the synthetic 100-dispute evaluation dataset + DemoDisputeProvider
...
import { DemoDisputeProvider } from '../src/providers/demoProvider.js';
...
test('DemoDisputeProvider loads 100 disputes with provider=demo, never Razorpay', () => {
  const res = DemoDisputeProvider.loadDemoDataset(100, { regenerateDrafts: true });
...
test('DemoDisputeProvider clears previously loaded demo disputes', () => {
...
test('evaluation computes population metrics + detection vs ground truth', () => {
  DemoDisputeProvider.clearDemoDataset();
  DemoDisputeProvider.loadDemoDataset(100, { regenerateDrafts: true });
